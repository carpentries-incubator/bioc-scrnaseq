...
# Cell types seen only a handful of times across all samples carry no useful
# information about differential abundance, and edgeR cannot estimate a
# dispersion for them, so we drop them first.
keep.ab <- rowSums(y.ab$counts) >= 5
